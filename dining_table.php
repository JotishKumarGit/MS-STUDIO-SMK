...
<head>
    ...
    <title>MS STUDIO SMK - Dining Table</title>
        ...
        <div class="container position-relative" style="z-index: 1;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active text-warning" aria-current="page">Dining Table</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid py-5 bg-light">
        <div class="container">
            ...
            <p class="text-center mb-5" data-aos="flip-right" data-aos-delay="500" data-aos-duration="1200">
                Discover our exquisite dining tables that combine style, comfort, and durability. Perfect for family gatherings and elegant dining experiences.
            </p>

            <!-- Product 1 -->
            <div class="row align-items-center g-4 mb-5">
                <div class="col-lg-6 col-md-12" data-aos="fade-right" data-aos-duration="1000">
                    <img src="assets/img/Dining_table.jpeg" class="img-fluid rounded shadow" alt="Elegant Dining Table" style="width:100%; object-fit:cover;">
                </div>
                <div class="col-lg-6 col-md-12" data-aos="fade-left" data-aos-duration="1000">
                    <div class="p-3">
                        <h2 class="mb-3" data-aos="zoom-in" data-aos-delay="200">Elegant Dining Table</h2>
                        <p data-aos="fade-up" data-aos-delay="400">
                            Crafted to perfection, this Elegant Dining Table is the centerpiece of any dining room. Perfect for family meals and entertaining guests.
                        </p>
